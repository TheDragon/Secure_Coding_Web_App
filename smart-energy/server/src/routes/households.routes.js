...
router.post('/', requireAuth, requireRole('admin'), householdCreateValidator, sanitizeBodyStrings(['name', 'address', 'residentName']), validateRequest, createHousehold);
...
router.delete('/:id', requireAuth, requireRole('admin'), deleteHousehold);
